import { c as createLucideIcon, R as React, r as reactExports, l as CircleHelp, j as jsxRuntimeExports, S as ShoppingCart, f as formatINR, L as Link } from "./index-vpbP6K3q.js";
...
import { a as clsx, B as Button } from "./button-DhRdAl0g.js";
import { a as mockBuyers, c as mockProducts, e as mockRFQs } from "./mockData-BxT47ZmF.js";
...
import { f as filterProps, g as Layer, H as max, s as isNumber, l as Curve, A as Animate, q as interpolateNumber, m as isNil, I as isNan, r as isEqual, J as hasClipDot, t as LabelList, u as uniqueId, i as isFunction, G as Global, n as getValueByDataKey, K as getCateCoordinateOfLine, D as Dot, E as generateCategoricalChart, X as XAxis, Y as YAxis, M as formatAxisMap, R as ResponsiveContainer, C as CartesianGrid, T as Tooltip } from "./generateCategoricalChart-CLakrVV0.js";
/**
...
const SUPPLIER_NAV = [
  ...
  { label: "Analytics", href: "/supplier/analytics", icon: ChartNoAxesColumn },
  ...
  { label: "Support", href: "/supplier/support", icon: CircleHelp }
];
const STATUS_COLORS = {
...
const revenueData = [
  { month: "Feb", revenue: 145e4 },
  { month: "Mar", revenue: 182e4 },
  { month: "Apr", revenue: 21e5 }
];
const topBuyers = [
  {
    id: "buy-001",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PortalLayout, { sidebarItems: SUPPLIER_NAV, portalName: "Supplier Portal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        ...
        actions: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-emerald-100 text-emerald-700 border border-emerald-200 gap-1 px-2.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        StatCard,
        {
          label: "Pending RFQs",
          value: 7,
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "size-4" }),
          trend: -5,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "xl:col-span-2 rounded-lg border bg-card p-5 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground", children: "Revenue Trend" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: "Last 3 months" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          AreaChart,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "supRevGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "5%", stopColor: "#059669", stopOpacity: 0.2 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "95%", stopColor: "#059669", stopOpacity: 0 })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                CartesianGrid,
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border bg-card p-5 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground mb-4", children: "Top Buyers" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: topBuyers.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-bold text-muted-foreground w-4 shrink-0", children: [
            "#",
            i + 1
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded-full bg-[#059669]/10 text-[#059669] flex items-center justify-center text-xs font-bold shrink-0", children: b.company.charAt(0) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground shrink-0", children: formatINR(b.value) })
        ] }, b.id)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/supplier/analytics", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "outline",
            size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border bg-card shadow-sm mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-5 py-4 border-b", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Inbox, { className: "size-4 text-muted-foreground" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground", children: "Incoming RFQs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-amber-100 text-amber-700 border border-amber-200 text-xs", children: "7 new" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/supplier/rfq-leads", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "text-[#059669]", children: "View all" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y", children: recentRFQs.map((rfq) => {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-8 rounded bg-muted flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "size-4 text-muted-foreground" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: (buyer == null ? void 0 : buyer.company) ?? "Unknown Buyer" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground truncate", children: [
                    (product == null ? void 0 : product.name) ?? `Product #${rfq.productId}`,
                    " · Qty:",
                    " ",
                    rfq.quantity
                  ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/supplier/products", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/supplier/rfq-leads", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          className: "bg-[#1e40af] hover:bg-[#1e3a8a] text-white",
          "data-ocid": "quick-rfq-leads-btn",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardList, { className: "size-4 mr-2" }),
            "View RFQ Leads"
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/supplier/analytics", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", "data-ocid": "quick-analytics-btn", children: [
...
const SupplierDashboardPage$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  SUPPLIER_NAV,
