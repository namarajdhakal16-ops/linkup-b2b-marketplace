import { c as createLucideIcon, j as jsxRuntimeExports, X, R as React, b as useRouterState, L as Link, r as reactExports, g as useAuthStore, e as useInternetIdentity, d as useNavigate, k as Settings } from "./index-vpbP6K3q.js";
import { c as cn, B as Button, u as useComposedRefs, f as composeRefs, F as Factory } from "./button-DhRdAl0g.js";
import { R as Root$1, C as Content, b as Close, T as Title, d as Portal$1, O as Overlay, e as Trigger$1, a as Presence } from "./index-BfZ639JC.js";
import { M as Menu$1 } from "./menu-dXZt9xRu.js";
import { a as useId, P as Primitive, c as composeEventHandlers, b as createContextScope, u as useControllableState, g as useCallbackRef, f as Portal$2, h as hideOthers, k as dispatchDiscreteCustomEvent, i as useFocusGuards, R as ReactRemoveScroll, F as FocusScope, D as DismissableLayer, j as createSlot } from "./index-CPoAQatq.js";
import { b as createCollection, u as useDirection, R as Root2$1, A as Anchor, c as createPopperScope, d as Content$1, e as Arrow, C as ChevronDown } from "./index-CN9hoFXr.js";
/**
...
function NavLinks({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-0.5 flex-1", children: items.map((item) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Link,
      {
        ...
        className: cn(
          ...
          isActive ? "bg-primary/20 text-primary border border-primary/30" : "text-slate-300 hover:bg-white/10 hover:text-white"
        ),
        children: [
          Icon && /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "size-4 shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-1 min-w-0 truncate", children: item.label }),
          item.badge !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto bg-primary text-primary-foreground text-xs px-1.5 py-0.5 rounded-full shrink-0", children: item.badge })
        ]
      },
      item.href
    );
...
function Sidebar({ items, logo, footer }) {
  const [mobileOpen, setMobileOpen] = React.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden fixed top-4 left-4 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: mobileOpen, onOpenChange: setMobileOpen, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SheetContent,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-5 border-b border-slate-700", children: [
              logo,
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-3 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLinks, { items, onClose: () => setMobileOpen(false) }) }),
            footer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-700 px-3 py-4", children: footer })
          ] })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden lg:flex flex-col w-64 shrink-0 bg-[#0f172a] border-r border-slate-700 h-screen sticky top-0", children: [
      logo && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-5 border-b border-slate-700", children: logo }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto px-3 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLinks, { items }) }),
      footer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-slate-700 px-3 py-4", children: footer })
    ] })
  ] });
}
...
function Topbar({ title, className }) {
  ...
  const shortPrincipal = principal ? `${principal.slice(0, 6)}...${principal.slice(-4)}` : "Unknown";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: cn(
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden w-10" }),
          " ",
          title && /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-base font-semibold text-foreground truncate hidden sm:block", children: title }),
          userRole && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden md:inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs font-medium bg-primary/10 text-primary border border-primary/20", children: ROLE_LABELS[userRole] })
        ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 right-1.5 size-2 bg-red-500 rounded-full" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-7 rounded-full bg-primary/20 text-primary flex items-center justify-center text-xs font-bold border border-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "size-3.5" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-sm text-muted-foreground max-w-[140px] truncate", children: shortPrincipal }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "size-3.5 text-muted-foreground shrink-0" })
                ]
              }
            ) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-52", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { className: "font-normal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground", children: "Principal ID" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: shortPrincipal })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuItem, { className: "cursor-pointer", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "size-4 mr-2" }),
                "Settings"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuSeparator, {}),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function PortalLayout({
  ...
  const Logo = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "size-7 rounded bg-[#1e40af] flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Factory, { className: "size-4 text-white" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-white text-sm leading-none", children: "LinkUp" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-slate-400 text-[10px] leading-none mt-0.5", children: portalName })
    ] })
  ] });
  const SidebarFooter = /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      onClick: handleLogout,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen overflow-hidden bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Sidebar, { items: sidebarItems, logo: Logo, footer: SidebarFooter }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col overflow-hidden min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Topbar, { title: portalName, className: "lg:pl-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: cn("flex-1 overflow-y-auto", className), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-[1400px] mx-auto p-4 sm:p-6 lg:p-8", children }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-muted/40 px-6 py-3 mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground text-center", children: [
          "© ",
          currentYear,
